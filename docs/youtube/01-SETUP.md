...
> 💡 **Детальный гайд**: Для полной пошаговой инструкции по настройке Google Cloud Console с нуля (включая создание аккаунта, все настройки, решение проблем), см. [Google Cloud Console Setup Guide](../setup/GOOGLE_CLOUD_CONSOLE_SETUP.md)
...
# Проверьте импорты
python -c "from core.database.mysql_db import get_mysql_database; print('✅ OK')"
```
