...
CREATE TABLE IF NOT EXISTS youtube_channels (
    ...
    console_name VARCHAR(255) COMMENT 'Reference to google_consoles.name (required for OAuth)',
    access_token TEXT,
    refresh_token TEXT,
    token_expires_at DATETIME,
    console_id INT COMMENT 'Reference to google_consoles.id (alternative to console_name)',
    ...
    INDEX idx_console_id (console_id),
    INDEX idx_enabled (enabled),
