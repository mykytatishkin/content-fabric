...
todos:
  - id: todo-1769888164331-uaxbiabox
    content: обернуть все еще в регистрацию пользователя и подвязки всех данных под пользователя
    status: pending
  - id: todo-1769888182463-482y7r89e
    content: нужно добавить админ панель где можно смотреть действия пользователей и админить приложение
    status: pending
  - id: todo-1769888203232-rfgh3slsx
    content: ""
    status: pending
isProject: false
---
